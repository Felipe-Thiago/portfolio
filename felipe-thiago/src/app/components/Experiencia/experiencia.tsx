            ...
            <div className="mx-12 w-2/3">
                ...
                <div className="my-5">
                    <Accordion defaultValue="etec">
                        <Accordion.Item value="etec">
                            <Accordion.Trigger className="flex w-full justify-between items-center gap-5 px-5 rounded-t-2xl bg-blue-900 group-data-[open=false]:rounded-2xl">
                                <p className="text-blue-400 font-bold">Técnico em Desenvolvimento de Sistemas </p><IoIosArrowDown className="h-4 w-4 group-data-[open=true]:rotate-180"/>
                            ...
                            <Accordion.Content className="p-5 md:pb-20 pb-40 border rounded-b-2xl content-center justify-center">
                ...
                <Accordion defaultValue="fatec">
                    <Accordion.Item value="fatec">
                        <Accordion.Trigger className="flex w-full justify-between items-center gap-5 px-5 rounded-t-2xl bg-blue-900 group-data-[open=false]:rounded-2xl">
                            <p className="text-blue-400 font-bold">Desenvolvedor de Software Multiplataforma</p><IoIosArrowDown className="h-4 w-4 group-data-[open=true]:rotate-180"/>
